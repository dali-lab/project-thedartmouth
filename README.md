...
We'll have to use some Terminal command line dark magic here.  Copy/paste is your friend.  
  ...
  <br>![](docs/img/square.png) 2.2)  ```git clone https://github.com/dali-lab/project-thedartmouth.git```
  <br>![](docs/img/square.png) 2.3)  ```cd project-thedartmouth```
...
Now you can go to [http://dali-lab.github.io/project-thedartmouth](http://dali-lab.github.io/project-thedartmouth) to see your site!
